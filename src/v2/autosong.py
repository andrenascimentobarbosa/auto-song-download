...
path_dir_songs = r'/home/andre/auto-song-download/src/v2/songs'
path_dir_videos = r'/home/andre/auto-song-download/src/v2/videos'
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print('./script.py songlist.txt mp3/mp4')
    else:
        if sys.argv[2] == 'mp3':
            links = sys.argv[1]
            main_song(links)
